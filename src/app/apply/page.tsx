  ...
  function validateStep(s: number): boolean {
    ...
    switch (s) {
      ...
      case 3:
        return true;
      case 4:
        if (!statement.trim()) { setError("Statement of intent is required."); return false; }
        return true;
      case 5:
        if (!affirmPrinciples) { setError("You must affirm the five principles to continue."); return false; }
        return true;
      case 6:
        if (!emergencyName.trim()) { setError("Emergency contact name is required."); return false; }
        if (!emergencyPhone.trim()) { setError("Emergency contact phone is required."); return false; }
        if (!referenceName.trim()) { setError("Member reference name is required."); return false; }
        return true;
      default:
        return true;
    }
      ...
      <form onSubmit={handleSubmit}>
        ...
        {step === 1 && (
          <div className="space-y-5">
            ...
            <div>
              ...
              <input
                type="text" id="fullName" required value={fullName}
            ...
            <div className="pt-4 flex justify-end">
              <button type="button" onClick={goNext} className="px-6 py-2.5 bg-[var(--gold)] text-[var(--dark-bg)] font-semibold rounded-lg text-sm hover:bg-[var(--gold-light)] transition-colors">
                Continue
              </button>
            </div>
          </div>
        ...
        {step === 2 && (
          <div className="space-y-5">
            ...
            <div>
              <label htmlFor="skills" className={labelClass}>Skills, Profession, or Expertise You Can Contribute</label>
              <textarea
                id="skills" rows={3} value={skills}
            ...
            <div className="pt-4 flex justify-between">
              <button type="button" onClick={goBack} className="px-6 py-2.5 border border-[var(--gray-300)] text-[var(--gray-700)] font-semibold rounded-lg text-sm hover:bg-[var(--gray-50)] transition-colors">
                Back
              </button>
              <button type="button" onClick={goNext} className="px-6 py-2.5 bg-[var(--gold)] text-[var(--dark-bg)] font-semibold rounded-lg text-sm hover:bg-[var(--gold-light)] transition-colors">
                Continue
        ...
        {step === 3 && (
          <div className="space-y-5">
            ...
            <div>
              <label htmlFor="moorishStatus" className={labelClass}>Are you currently proclaimed Moorish American?</label>
              <select id="moorishStatus" value={moorishStatus} onChange={(e) => setMoorishStatus(e.target.value)} className={selectClass}>
            ...
            <div>
              <label htmlFor="identificationDuration" className={labelClass}>How long have you identified with this heritage?</label>
              <select id="identificationDuration" value={identificationDuration} onChange={(e) => setIdentificationDuration(e.target.value)} className={selectClass}>
                <option value="">Select...</option>
            ...
            <div>
              <label htmlFor="lineage" className={labelClass}>Family Lineage or Tribal/Family Connections (optional)</label>
              <textarea
                id="lineage" rows={3} value={lineage}
            ...
            <div>
              <label htmlFor="priorAffiliations" className={labelClass}>Previous Organizational Affiliations (optional)</label>
              <textarea
                id="priorAffiliations" rows={3} value={priorAffiliations}
        ...
        {step === 4 && (
          <div className="space-y-5">
            ...
            <div>
              ...
              <select id="surnamePref" value={surnamePref} onChange={(e) => setSurnamePref(e.target.value)} className={selectClass}>
            ...
            <div>
              ...
              <textarea
                id="statement" required rows={4} value={statement}
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-4">
              <label className={checkboxLabelClass}>
                <input type="checkbox" checked={canAttendAssemblies} onChange={(e) => setCanAttendAssemblies(e.target.checked)} className={checkboxClass} />
                <span className="text-sm text-[var(--gray-700)]">I am willing to attend assemblies and gatherings</span>
              </label>

              <label className={checkboxLabelClass}>
                <input type="checkbox" checked={canPayDues} onChange={(e) => setCanPayDues(e.target.checked)} className={checkboxClass} />
                <span className="text-sm text-[var(--gray-700)]">I am willing to contribute dues as established by the Council</span>
              </label>

              <label className={checkboxLabelClass}>
                <input type="checkbox" checked={canParticipate} onChange={(e) => setCanParticipate(e.target.checked)} className={checkboxClass} />
                <span className="text-sm text-[var(--gray-700)]">I am willing to participate in community programs and initiatives</span>
              </label>
            </div>
            ...
            <div>
              ...
              <select id="constitutionRead" value={constitutionRead} onChange={(e) => setConstitutionRead(e.target.value)} className={selectClass}>
                <option value="">Select...</option>
                <option value="Yes">Yes</option>
                <option value="No">No</option>
            ...
            <div className="border border-[var(--gold)]/30 rounded-xl p-5 bg-[var(--gold)]/5">
              <label className={checkboxLabelClass}>
                <input type="checkbox" checked={affirmPrinciples} onChange={(e) => setAffirmPrinciples(e.target.checked)} className={checkboxClass} />
                <span className="text-sm text-[var(--gray-700)]">
                  I affirm the five principles — <strong>Love, Truth, Peace, Freedom, and Justice</strong> — and commit to upholding them as a member of the Sultanate. *
                </span>
              </label>
            </div>
        ...
        {step === 6 && (
          <div className="space-y-5">
            ...
            <h3 className="text-sm font-semibold text-[var(--gray-900)]">Emergency Contact</h3>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label htmlFor="emergencyName" className={labelClass}>Contact Name *</label>
                <input type="text" id="emergencyName" required value={emergencyName} onChange={(e) => setEmergencyName(e.target.value)} className={inputClass} />
              </div>
              <div>
                <label htmlFor="emergencyPhone" className={labelClass}>Contact Phone *</label>
                <input type="tel" id="emergencyPhone" required value={emergencyPhone} onChange={(e) => setEmergencyPhone(e.target.value)} placeholder="(000) 000-0000" className={inputClass} />
              </div>
            </div>

            <div>
              <label htmlFor="emergencyRelationship" className={labelClass}>Relationship</label>
              <input type="text" id="emergencyRelationship" value={emergencyRelationship} onChange={(e) => setEmergencyRelationship(e.target.value)} placeholder="e.g. Spouse, Parent, Sibling" className={inputClass} />
            </div>

            <div className="h-px bg-[var(--gray-200)] my-2" />

            <h3 className="text-sm font-semibold text-[var(--gray-900)]">Member Reference</h3>
            <p className="text-xs text-[var(--gray-500)] -mt-3">Someone who is already a member of the Sultanate.</p>

            <div>
              <label htmlFor="referenceName" className={labelClass}>Reference Name *</label>
              <input type="text" id="referenceName" required value={referenceName} onChange={(e) => setReferenceName(e.target.value)} className={inputClass} />
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label htmlFor="referencePhone" className={labelClass}>Reference Phone</label>
                <input type="tel" id="referencePhone" value={referencePhone} onChange={(e) => setReferencePhone(e.target.value)} placeholder="(000) 000-0000" className={inputClass} />
              </div>
              <div>
                <label htmlFor="referenceEmail" className={labelClass}>Reference Email</label>
                <input type="email" id="referenceEmail" value={referenceEmail} onChange={(e) => setReferenceEmail(e.target.value)} placeholder="reference@example.com" className={inputClass} />
              </div>
            </div>

            <div>
              <label htmlFor="referenceRelationship" className={labelClass}>Relationship to Reference</label>
              <input type="text" id="referenceRelationship" value={referenceRelationship} onChange={(e) => setReferenceRelationship(e.target.value)} placeholder="e.g. Friend, Family, Community member" className={inputClass} />
            </div>
          ...
          <div className="space-y-5">
            ...
            <div className="bg-[var(--gray-50)] rounded-xl p-5 space-y-5 text-sm">
              <SummarySection title="Personal Information">
                ...
                <SummaryRow label="Address" value={[address, city, state, zip].filter(Boolean).join(", ")} />
              </SummarySection>
              ...
              <SummarySection title="Heritage &amp; Background">
                ...
                <SummaryRow label="Heritage Duration" value={identificationDuration} />
                <SummaryRow label="Lineage" value={lineage} />
                <SummaryRow label="Prior Affiliations" value={priorAffiliations} />
              </SummarySection>
              ...
              <SummarySection title="Commitments">
                <SummaryRow label="Attend Assemblies" value={canAttendAssemblies} />
                <SummaryRow label="Contribute Dues" value={canPayDues} />
                <SummaryRow label="Participate in Programs" value={canParticipate} />
                <SummaryRow label="Constitution Read" value={constitutionRead} />
                <SummaryRow label="Affirm Five Principles" value={affirmPrinciples} />
              </SummarySection>
              ...
              <SummarySection title="Emergency Contact &amp; Reference">
                ...
                <SummaryRow label="Emergency Relationship" value={emergencyRelationship} />
                ...
                <SummaryRow label="Reference Relationship" value={referenceRelationship} />
              </SummarySection>
            </div>

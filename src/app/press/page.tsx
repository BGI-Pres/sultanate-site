...
export const metadata: Metadata = {
  title: "Press & Media",
  description:
    "Official statements, press releases, and media resources from the Sultanate of Amexem — the custodial governing authority for the descendants of the Nation of Moab.",
};
      ...
      <section className="bg-[var(--dark-bg)] py-12 md:py-20 border-b-2 border-[var(--gold)]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg text-white/70 max-w-3xl leading-relaxed">
            Official statements and media resources from the Sultanate of

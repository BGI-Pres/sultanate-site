...
function SocialButton({
  ...
  return (
    <button
      onClick={handleClick}
      disabled={loading}
      className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-[var(--gray-300)] rounded-md text-sm font-medium text-[var(--gray-700)] bg-white hover:bg-[var(--gray-50)] transition-colors disabled:opacity-50"
    >
      {icon}
  ...
  return (
    <div className="w-full max-w-md">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <span className="text-xs text-[var(--gray-500)] uppercase tracking-wider">or sign in with email</span>
        <div className="flex-1 h-px bg-[var(--gray-200)]" />
      </div>
      ...
      <p className="text-center text-sm text-[var(--gray-500)] mt-2">
        <Link href="/" className="hover:underline">
          &larr; Return to Sultanate of Amexem
        </Link>
      </p>
    </div>
  );
